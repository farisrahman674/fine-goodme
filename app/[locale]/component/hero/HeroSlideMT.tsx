  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/HERO-IMAGES/bg-milktea.png"
          alt="background"
          fill
          priority
      ...
      >
        <Image
          src="/HERO-IMAGES/milktea-machine.png"
          alt="mesin es krim"
          width={0}
          height={0}
          sizes="100vw"
      ...
      <div className="relative z-20 w-full h-full flex items-center bottom-0 md:-bottom-20 lg:bottom-0">
        <div className="pl-8 md:pl-16 lg:pl-44 max-w-8xl text-white">
          <h1
            className={`text-4xl sm:text-6xl font-bold leading-tight [text-shadow:0_4px_9px_rgba(0,0,0,0.7)] max-w-7xl ${heroVisible ? "animate__animated animate__bounce" : "opacity-0 -translate-x-40"}`}
          >
            <span className="text-4xl sm:text-[85px] ">
              {locale === "id" ? dict.hero.titleTop : dict.hero.titleBottomMT}
            </span>
            <br />
            {locale === "id" ? dict.hero.titleBottomMT : dict.hero.titleTop}
          </h1>
